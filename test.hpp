...
{" (found before start of program)",
 " (in '/home/js/programs/misc/test.stan', line 8, column 2 to column 9)",
 " (in '/home/js/programs/misc/test.stan', line 9, column 2 to column 9)",
 " (in '/home/js/programs/misc/test.stan', line 10, column 2 to column 9)",
 " (in '/home/js/programs/misc/test.stan', line 14, column 2 to column 27)",
 " (in '/home/js/programs/misc/test.stan', line 2, column 2 to column 17)",
 " (in '/home/js/programs/misc/test.stan', line 3, column 9 to column 10)",
 " (in '/home/js/programs/misc/test.stan', line 3, column 2 to column 14)",
 " (in '/home/js/programs/misc/test.stan', line 4, column 9 to column 10)",
 " (in '/home/js/programs/misc/test.stan', line 4, column 2 to column 14)"};
...
class test_model final : public model_base_crtp<test_model> {
 ...
 public:
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    try {
      ...
      s = in__.template read<local_scalar_t__>();
      {
        ...
        lp_accum__.add(normal_lpdf<propto__>(y, add(multiply(x, m), b), s));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
  ...
  inline void get_param_names(std::vector<std::string>& names__) const {
    ...
    names__ = std::vector<std::string>{"m", "b", "s"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    ...
    return std::string("[{\"name\":\"m\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"b\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"s\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"}]");
